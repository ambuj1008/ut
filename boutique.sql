...
--
-- Host: localhost
-- Generation Time: Feb 13, 2016 at 03:20 PM
...
INSERT INTO `admin` (`sr_no`, `adminid`, `password`) VALUES
(1, 'admin', 'fairy'),
(2, 'birju', 'maa');
...
INSERT INTO `item_detail` (`sr_no`, `item_name`, `description`, `picture`, `item_category`, `price`) VALUES
...
INSERT INTO `registration` (`sr_no`, `userid`, `password`, `firstname`, `lastname`, `bdate`, `gen`, `address`, `phone`, `city`, `state`, `country`, `zipcode`, `email`) VALUES
(0, 'ambuj', 'dwivedi', 'ambuj', 'dwivedi', '10-august-1994', 'male', 'allahabad', 2147483647, 'allahabad', 'up', 'india', '212507', 'ambujdwivedi02@gmail.com');
...
INSERT INTO `sales_mast` (`bill_no`, `userid`, `address`, `city`, `state`, `country`, `date`, `total_amt`, `cr_no`) VALUES
...
INSERT INTO `sales_trans` (`sr_no`, `bill_no`, `item_name`, `description`, `qty`, `amt`) VALUES
